...
public class UserController {
    ...
    public UserController(IEmployeeService iEmployeeService, ICustomerService iCustomerService) {
    ...
    public void setAvailability(@RequestBody Set<DayOfWeek> daysAvailable, @PathVariable long employeeId) {
        iEmployeeService.addScheduleById(employeeId, daysAvailable);
    }

    @GetMapping("/employee/availability")
    public List<EmployeeDTO> findEmployeesForService(@RequestBody EmployeeRequestDTO employeeDTO) {
        return iEmployeeService.findByDayOfWeekAndSkills(employeeDTO);
    }
